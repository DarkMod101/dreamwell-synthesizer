...
function stealOldestChoirVoice() {
    if (activeChoirNodes.length >= MAX_CHOIR_VOICES) {
        ...
        if (oldestVoice && oldestVoice.steal) {
            oldestVoice.steal();
        }
    }
}
